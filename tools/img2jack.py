...
def process_argument():
    ...
    parser.add_argument('-t', '--threshold', type=int, help='黑白參數，設定值越大則輸出隻圖片越黑，設置成-1則使用binarized演算法', default=-1)
    parser.add_argument('-s', action='store_true', dest='smooth', help='是否平滑化圖片')
    parser.add_argument('-o', action='store_true', dest='optimized', help='是否優化輸出函數數量')
